...
public class JsoupTest {
    ...
    public void test() throws IOException {
        ...
        System.out.println("---------------------------");
        Elements select = doc.select("div.live_index_grid ul li:nth-child(1)");
        for (Element element : select) {
            System.out.println(element.toString());
        }
        System.out.println("---------------------------");
        select = doc.select("div.live_index_grid ul li:nth-child(2)");
        for (Element element : select) {
            System.out.println(element.toString());
        }
        System.out.println("---------------------------");
        select = doc.select("div.live_index_grid ul li:nth-child(3)");
        for (Element element : select) {
            System.out.println(element.toString());
        }
        System.out.println("---------------------------");
        select = doc.select("div.live_index_grid ul li:nth-child(odd)");
        for (Element element : select) {
            System.out.println(element.toString());
        }
